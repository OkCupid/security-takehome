...
5. Create a file named `permissions.txt` and grant all permissions to the owner of the file, read and execute permissions for the group, and execute permissions for all other users. Take a screenshot the file permissions after you are done.
